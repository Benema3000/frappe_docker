...
def extend_boot(bootinfo):
    """
    bootinfo is een dict-like object dat wordt geÃ¯njecteerd in frappe.boot
...
| Feature | v14 | v15 |
|---------|-----|-----|
| extend_bootinfo | âœ… | âœ… |
| on_session_creation | âœ… | âœ… |
| on_login / on_logout | âœ… | âœ… |
| Boot data compressie | - | âœ… Verbeterd |
