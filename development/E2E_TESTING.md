...
| ------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Good Event registration, localized validation, input limits, coupon, mobile, persistence         | [`test_e2e_playwright.py`](frappe-bench/apps/good_event/good_event/tests/test_e2e_playwright.py), [`test_good_event.py`](frappe-bench/apps/good_event/good_event/tests/test_good_event.py)               | Passed locally on 2026-07-19; hosted CAPTCHA/origin retest remains external UAT                                                                                                                                    |
| Good Event capacity overflow and real Waitlisted draft creation                                  | [`test_e2e_playwright.py`](frappe-bench/apps/good_event/good_event/tests/test_e2e_playwright.py), [`test_event_status.py`](frappe-bench/apps/good_event/good_event/tests/test_event_status.py)           | Passed locally on 2026-07-19; deployed waitlist/cancellation matrix not executed in this run                                                                                                                       |
| Good Event linked venue translation on detail/registration/list rendering                        | [`test_language_contract.py`](frappe-bench/apps/good_event/good_event/tests/test_language_contract.py), [`test_e2e_playwright.py`](frappe-bench/apps/good_event/good_event/tests/test_e2e_playwright.py) | Server contract passed locally; full deployed DE/FR/IT visual review remains UAT                                                                                                                                   |
| MiKi canonical portal fields, archived field limits, normalization, non-persistence on rejection | [`test_portal_field_contract.py`](frappe-bench/apps/miki_app/miki_app/tests/test_portal_field_contract.py), [`test_e2e_playwright.py`](frappe-bench/apps/miki_app/miki_app/tests/test_e2e_playwright.py) | Passed locally on 2026-07-19; one hosted positive scenario reached the real form and exposed response-visibility and `ChUid` adapter regressions, with the full 15-scenario matrix pending deployment of the fixes |
| MiKi workflow, correspondence queue, invoice, QR SVG, Dunning, portal files                      | [`test_end_to_end.py`](frappe-bench/apps/miki_app/miki_app/tests/test_end_to_end.py), [`test_e2e_playwright.py`](frappe-bench/apps/miki_app/miki_app/tests/test_e2e_playwright.py)                       | Passed locally on 2026-07-19; real inbox, Payrexx, and hosted file wrapper remain external boundaries                                                                                                              |
| MiKi per-declaration escalation rollback when correspondence fails                               | [`test_end_to_end.py`](frappe-bench/apps/miki_app/miki_app/tests/test_end_to_end.py)                                                                                                                     | Focused server regression passed locally; hosted scoped-run proof remains pending deployment                                                                                                                       |
